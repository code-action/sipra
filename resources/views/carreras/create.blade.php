...
@section('contenidoPagina')
	<div class="col-xs-6">
		<div class="form-panel">
			...
			<center><h4><a href={!! asset('/ayudar/14') !!} target="blank_" class="tooltips" data-placement="right" data-original-title="Ayuda"><i class="fa fa-graduation-cap"></i></a> Crear carrera </h4></center><hr>
